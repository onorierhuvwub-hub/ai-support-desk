...
// Valid JWT structure fallback to guarantee Supabase client never fails initialization during Vercel builds
...
// Persistent Global Store across Next.js dev server reloads & Vercel serverless executions
declare global {
